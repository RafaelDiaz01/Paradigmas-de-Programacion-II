...
class Laptop (Sprite):
    ...
    def __init__(self, screen, esc_alumno_config, esc_alumno_personaje): # Objeto de las configuraciones, screen y alumno.
    ...
    def update_laptop(self):
        # Condicional para disparar
        if self.is_shoot and (self.image_laptop_rect.top > self.screen_rect.top):
