...
#Programa que demuestra el uso de los tipos básicos de datos en Python
...
# Número entero
mi_variable_entera = 7
print("Tipo de dato entero:",mi_variable_entera)

# Número decimal
mi_variable_decimal = 9.19
print("Tipo de dato decimal:", mi_variable_decimal)

# Cadena de texto
mi_variable_texto_nombre = "Kevin"
mi_variable_texto_apellido = 'Díaz'
